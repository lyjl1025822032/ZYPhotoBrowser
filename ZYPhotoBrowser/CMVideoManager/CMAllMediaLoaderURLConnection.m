//
//  CMAllMediaLoaderURLConnection.m
//  CmosAllMedia
//
...
@interface CMAllMediaLoaderURLConnection ()<CMAllMediaVideoRequestTaskDelegate>
@property (nonatomic, strong) NSMutableArray *pendingRequests;
@property (nonatomic, copy) NSString *videoPath;
@end

@implementation CMAllMediaLoaderURLConnection
- (instancetype)init {
    self = [super init];
    if (self) {
...
- (void)dealWithLoadingRequest:(AVAssetResourceLoadingRequest *)loadingRequest {
    ...
    if (!self.task) {
        self.task = [[CMAllMediaVideoRequestTask alloc] init];
...
#pragma mark - CMAllMediaVideoRequestTaskDelegate
